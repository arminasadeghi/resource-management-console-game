...
- `last.cpp` – main game source code (logic, game loop, save/load).
- `CHOICES.txt` – list of filenames containing scenario definitions.
- Scenario files (e.g. `choice1.txt`, `choice2.txt`, ...) – each file defines:
  - Scenario description text
  - Text for decision 1 and its effects on the three resources
  - Text for decision 2 and its effects on the three resources
